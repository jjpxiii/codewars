...
describe("Basic tests", () => {
  test("Can add up to 24 ?", () => {
    expect(equalTo24(1, 2, 3, 4)).toBe("4*3*2/1");
    expect(equalTo24(2, 3, 4, 5)).toBe("(5+4+3)*2");
    expect(equalTo24(3, 4, 5, 6)).toBe("(5+3-4)*6");
    expect(equalTo24(1, 1, 1, 13)).toBe("(1+1)*(13-1)");
